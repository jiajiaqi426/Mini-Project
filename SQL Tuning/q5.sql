...
-- There are only one column 'studId' need to be used. don't need to use derived tabel and give alias
--  Use WHERE and IN to remove duplicate records, subquery only one column
/*EXPLAIN ANALYZE
SELECT * FROM Student, 
